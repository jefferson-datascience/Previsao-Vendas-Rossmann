...
if pagina == "Apresentação": 
    ...
    st.image('https://raw.githubusercontent.com/jefferson-datascience/Previsao-Vendas-Rossmann/main//Imagens/LogoRossmann.jpg')
    ...
    st.text("**Promo**: Aumento médio de US$ 559.85 por dia (variação: US$ 556.31 – US$ 563.39).",  unsafe_allow_html=True)
